        ...
        <DIV id="contents">
            ...
            <div id="tabs">
                ...
                <div class="srch-inner-0070">
                    ...
                    <ul><li>업무구분</li>
                        <li><select title="업무구분" style="background:#ffffcc" onChange="javascripｔ:moveUrl(this);"> <!-- 사고종류에서 1503클릭시 나타납니다 -->
                                ...
                                <option value="${ctx }/views/add/0070_1.jsp" id="clr-0700" selected>2: 해제</option>
                            </select>
                        </li>
                    </ul>
              ...
              <div class="info01-wrap-0070">
                ...
                <div class="info01-inner-0070"><!-- 2:해제 선택시 나타납니다.-->
                    <table >
                        <caption>통장+인감분실 해제 상세내용 테이블</caption>
                        <colgroup>
                            <col style="width:15%">
                            <col style="width:10%">
                            <col style="width:15%">
                        ...
                        <tbody>
                            ...
                            <tr><th>비밀번호</th>
                                ...
                                <th>개설점의은행거래신청서징구 또는 EDMS본인확인</th>
                                <td><select disabled title="개설점의은행거래신청서징구 또는 EDMS본인확인" style="background:#e5e5e5"><option>&nbsp;</option></select></td></tr>
                        </tbody>
                    </table>
              ...
              <div class="info02-wrap-0070">
                <div class="info02-inner-0070">
                    <table>
                        <caption>조회 데이터 해당 내역 테이블</caption>
                        <colgroup>
                            <col style="width:10%" >
                            <col style="width:10%" >
                            <col style="width:10%" >
                        ...
                        <tbody>
                            <tr><th>코드명</th>
	                            	<td><input type="text" readonly="readonly" style="background:#e5e5e5"></td>
	                                <th>등록일시</th>
	                                <td><input type="text" readonly="readonly"  style="background:#e5e5e5; width:48%"><input type="text" readonly="readonly"  style="background:#e5e5e5; width:48%"></td>
	                                <th>등록자</th>
	                                <td><input type="text" readonly="readonly" style="background:#e5e5e5; width:48%"><input type="text" readonly="readonly" style="background:#e5e5e5; width:48%"></td>
	                                <th>등록점명</th>
	                                <td><input type="text" readonly="readonly"  style="background:#e5e5e5"></td></tr>
                            <tr><td colspan="10"><textarea rows="5" cols="80" readonly="readonly"  style="background:#e5e5e5"></textarea></td></tr>
                        </tbody>
                    </table>
              ...
              <div class="btn_both">
                <div class="fr">
                    <a onclick="window.open('popup/pop_0070_1.html', '[0070] 주의사고 등록/해제 책임자승인사유창', 'width=900, height=380, location=no')"><input type="button" value="해제"></a>
                </div>
              </div>
