    ...
    <div id="container">
        ...
        <DIV id="contents">
            ...
            <div class="comment1">
                <div class="comt">
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="hl">통장훼손 재발행</span>은 통장이 훼손되어 사용할 수 없는 경우 새로운 통장으로 발행해 주는 화면입니다.</p>
                </div>
            </div>
            ...
            <div id="tabs">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><select title="거래종류" onChange="javascripｔ:moveUrl(this);" style="background:#ffffcc;">
                                ...
                                <option value="${ctx }/views/add/0008_3.jsp" selected>310: 훼손 재발행</option>
              ...
              <div class="info01-wrap-0070">
                <div class="info01-inner-0070">
                    <table>
                        <caption>훼손 재발행 조회 상세내용</caption>
                        <colgroup>
                            <col style="width:9%" >
                            <col style="width:15%" >
                            <col style="width:9%" >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th>중요증서번호</th><td><input type="text"></td>
                                <th>인감/서명구분</th>
                            ...
                            <tr>
                                <th colspan="3"><span class="note2 pointer">(*)개설점의은행거래신처서 징구 또는 EDMS본인확인</span></th>
                            ...
                            <tr>
                                ...
                                <th>통장 인자</th>
                                <td><select>
                                	<option value="">재인자 하지않음</option>
                                </select></td>
                                <th>거래번호</th><td><input type="text" readonly style="background:#e5e5e5"></td>
                            </tr>
                        </tbody>
                    </table>
                    
                    <div class="comment2 posi48">
                        <div class="close pointer"><img src="${ctx }/resources/image/icon/close.png" alt="닫기" /></div>
                        <div class="comt2">
                            <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EDMS</h5><br><br>
                            <p>EDMS(Electronic Document Management System) 전자문서 관리시스템.
                                EDMS를 통해 고객의 최초 계좌 개설시 은행거래 신청서와 신분증을 확인할 수 있습니다.</p>
                        </div>
                    </div>
