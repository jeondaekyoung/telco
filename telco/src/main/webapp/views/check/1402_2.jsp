...
<head>
    ...
    <script type="text/javascript" src="${ctx }/resources/vjs/check/1402_2.js"></script>
        ...
        <div id="contents">
            ...
            <div id="tabs">
                ...
                <div class="srch-inner-1401">
                    ...
                    <ul><li>
                        <select title="거래종류" onChange="javascripｔ:moveUrl(this);">
                            <option value="${ctx }/views/check/1402.jsp">201: 채번발행</option>
                            <option selected>221: 개별발행</option>
                        </select>
                    </li></ul>
              ...
              <div class="info01-wrap-0010">
                    ...
                    <div class="info01-inner03-0010" style="padding:15px 0px 22px">
                        <table class="tbl1402" >
                            ...
                            <tbody>
                                ...
                                <tr><th>의뢰인과의 관계</th>
                                    <td>
                                    	<select title="대리인과의 관계" id="client_relation" onchange="relationshipAccountHolder();">
                ...
                <div class="info01-title2-0010">
                    <h4>자기앞발행수수료</h4>
                    <div class="info01-inner02-0010" style="padding: 25px 5px; overflow:hidden">
                        <table >
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="2">
                                    	<select title="영수증인자" style="background:#e5e5e5" disabled="disabled">
                                        	<option value="01" selected>1: 예</option>
                                        </select>
                                    </td>
                                </tr>
                            </tbody>
