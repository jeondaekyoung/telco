    ...
    <div id="wrap">
        <div class="srch">
            <div class="srch-inner">
                <ul>
                    <li><label for="code">고객자격코드</label><input id="code" type="text" style="margin:0 21px 0 10px;"/>
                        <label for="type">고객자격유형</label><select id="type" style="margin:0 21px 0 10px;"><option>고객자격유형<option></select>
                        *미입력시 전체
                    </li>
                </ul>
            </div>
        ...
        <div class="qualify-info01">
            <table class="qualify" summury="고객자격검색결과">
