...
<script type="text/javascript" src="${ctx }/resources/vjs/automatic/1701.js"></script>
</head>
	...
	<div id="container">
		...
		<div id="contents">
			...
			<div id="tabs">
                ...
                <div class="srch-0002">
					...
					<div class="comment2 posi25">
						...
						<div class="comt2">
							<h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;비밀번호</h5>
							<br>	<br>
							<p>은행 창구에서 통장, 증서를 이용한 거래에 필요한 비밀번호로,
								<span class="hl">PIN패드로 고객이 직접 입력</span>하도록 합니다. 남이 쉽게 알 수 있는 동일한 숫자, 연속된 숫자, 전화번호나 실명번호 등은 사용할 수 없습니다.</p>
						</div>
					</div>                   
                </div>
					...
					<div class="info01-inner-1701 table0008">
						...
						<table>
							...
							<tbody>
                                <tr>
                                    <th>입금은행</th>
                                   <td><select title="은행종류" id="transfer_bank" style="background: #ffffcc;">
						...
						<div>
							<input type="button" value="내용추가" id="addContent" class="mybtn">
						</div>
				...
				<div class="btn_both">
					<div class="fr">
						<!-- <a onClick="window.open('popup/pop_1701.html','[1701]자동이체 등록','width=400, height=400, location=no')"> aaa</a> -->
