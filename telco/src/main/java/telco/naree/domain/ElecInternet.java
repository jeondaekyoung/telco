...
public class ElecInternet {
	...
	public String toString() {
		return "ElecInternet [elec_internet_no=" + elec_internet_no
				+ ", elec_info_no=" + elec_info_no + ", open_date=" + open_date
				+ ", open_branch=" + open_branch + ", cancel_date="
				+ cancel_date + ", cancel_branch=" + cancel_branch
				+ ", final_change_date=" + final_change_date + ", elec_id="
				+ elec_id + ", elec_pw=" + elec_pw + ", elec_transfer_day="
				+ elec_transfer_day + ", elec_transfer_once="
				+ elec_transfer_once + ", application_sepa=" + application_sepa
				+ ", user_id=" + user_id + ", owner_sepa=" + owner_sepa
